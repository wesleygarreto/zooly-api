...
insert into zooly.`user` (cd_user, name, email, password, note, cd_role, active, creation_date) values (1, 'King Arthur', 'kingdom@reign.com', 'imtheking123', "I'm strong.", 1, true, CURRENT_TIMESTAMP());
